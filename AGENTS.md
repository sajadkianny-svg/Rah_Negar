\# Rah\_Negar Project Instructions



\## Project

Rah\_Negar is a C# WinForms desktop application using SQLite.
...
\- Data entry is valid only from data\_start\_date onward.
...
4\. Inspect all NuGet packages for vulnerabilities, deprecation, incompatibility and redundant dependencies.
