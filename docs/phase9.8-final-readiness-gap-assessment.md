...
Status: **NOT_ELIGIBLE_FOR_ACTIVATION_DECISION**
...
|---|---|---|
| B-01 / G-97-13 installation-bound approval | OPEN | No real Production installation-bound approval, owner scope, expiry, or authorization |
